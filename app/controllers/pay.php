...
$new_order_query = "INSERT INTO orders(user_id, transaction_code, purchase_date, status_id, payment_mode_id, total) VALUES ('$user_id', '$trans_code', '$purchase_date', '$status_id', '$payment_mode_id', '$total');";
...
if($new_order){
	foreach($_SESSION['cart'] as $item_id => $qty){
		...
		$order_item_query = "INSERT INTO order_items(order_id, item_id, quantity, price) VALUES ('$new_order_id', '$item_id', '$qty', '" . $item['price']. "');";
